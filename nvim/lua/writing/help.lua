...
M.sections = {
  ...
  { "WRITING", {
    { "<Leader>wr", "centre this pane (reading mode)" },
  ...
  { "MANUSCRIPT", {
    ...
    { "<Leader>mn", "new chapter from template" },
    { "<Leader>mr", "rename chapter + update draft" },
  ...
  { "VAULT", {
    ...
    { ":SceneTemplate", "edit the chapter template" },
    { ":HarperSync", "sync ignores with the vault" },
    { ":SessionInfo", "saved layout for this vault" },
